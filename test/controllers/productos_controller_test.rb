...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { description: @producto.description, manufacturer: @producto.manufacturer, name: @producto.name, units: @producto.units }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { description: @producto.description, manufacturer: @producto.manufacturer, name: @producto.name, units: @producto.units }
    assert_redirected_to producto_path(assigns(:producto))
  end
